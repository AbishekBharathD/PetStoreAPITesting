...
public class Assertions {
    ...
    public void statusLineValidation(String expectedText) {
        ...
        if (!actual.contains(expectedText)) {
            String msg = "Status Line Failed: expected '" + expectedText + "', actual='" + actual + "'";
            Hooks.scenario.log(msg);
            Hooks.softAssert.fail(msg);
        } else {
    ...
    public void responseBodyContains(String expectedText) {
        ...
        if (!body.contains(expectedText)) {
            String msg = "Response Body Failed: expected to contain '" + expectedText + "', actual body='" + body + "'";
            Hooks.scenario.log(msg);
            Hooks.softAssert.fail(msg);
        } else {
            Hooks.scenario.log("Response Body Passed: contains '" + expectedText + "'");
        }
    }
}